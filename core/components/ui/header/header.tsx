...
const Header = ({
  ...
  <div className={cn('relative', className)}>
    <header className="flex h-[92px] items-center justify-between gap-1 overflow-y-visible bg-white px-4 md:px-10 lg:gap-8">
