    ...
    <DialogPrimitive.Root>
      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className="data-[state=open]:animate-contentShow fixed left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 bg-white shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none sm:w-8/12 md:w-3/4 md:w-6/12 lg:w-3/5 lg:w-5/12"
          id={id}
        >
